  ...
  <section
    ...
    <div className='wrapper-about-me'>
      ...
      <div>
        ...
        <p className='main-text'>Working as a product manager for the last 3 years I discovered my passion for User Interfaces and User Expierience. My urge to learn different UI approaches led me to the front-end development.</p>
